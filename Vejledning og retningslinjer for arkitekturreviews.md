...
For at realisere den fælles arkitektur er styregruppen for data og arkitektur nedsat i regi af digitaliseringsstrategien. Styregruppen har ansvaret for prioritering, udvikling, vedligehold og anvendelse af den fælles arkitektur, standarder og infrastruktur. Styregruppen skal, med reference til porteføljestyregruppen for den fællesoffentlige digitaliseringsstrategi, sikre tværgående koordinering, og at initiativerne både anvender og bidrager til den fælles arkitektur – til gavn for både projektet selv og hinanden.

For initiativer med et væsentligt indhold af data og arkitektur udføres arkitekturreviews, der vurderer, i hvilket omfang den fælles arkitektur anvendes, herunder om der sikres digital sammenhæng på tværs. Resultatet af et arkitekturreview skal forelægges styregruppen for data og arkitektur.

Denne vejledning har til formål at beskrive retningslinjer for arkitekturreviews i regi af digitaliseringsstrategien 2016-2020, herunder kriterier for projekter, der skal gennemgå reviews, review-proces samt procedurer i forbindelse hermed.
...
[Permanent URL til artiklen: https://arkitektur.digst.dk/node/1210](https://arkitektur.digst.dk/node/1210)
...
* [Retningslinjer for arkitekturreviews](#retningslinjer-for-arkitekturreviews)
  * [Introduktion til retningslinjerne](#introduktion-til-retningslinjerne)
  * [Hvilke projekter skal have foretaget arkitekturreviews?](#hvilke-projekter-skal-have-foretaget-arkitekturrev)
  * [Tre trin for arkitekturreviews](#tre-trin-for-arkitekturreviews)
  * [Hvilke typer af arkitekturreviews gennemføres?](#hvilke-typer-af-arkitekturreviews-gennemfres)
    * [Review af scope](#review-af-scope)
    * [Arkitekturdesign og -komponent reviews](#arkitekturdesign-og--komponent-reviews)
    * [Modelreviews](#modelreviews)
    * [Referencearkitektur-reviews](#referencearkitektur-reviews)
    * [Opsummering af de forskellige typer af reviews](#opsummering-af-de-forskellige-typer-af-reviews)
  * [Hvornår skal et projekt have foretaget arkitekturreviews?](#hvornr-skal-et-projekt-have-foretaget-arkitekturre)
  * [Reviewprocessen](#reviewprocessen)
    * [Arkitekturreview på 10 dage](#arkitekturreview-p-10-dage)
    * [Modelreviews](#modelreviews_2)
    * [Review-panel og reviewboard](#review-panel-og-reviewboard)
  * [Efterbehandling af reviews](#efterbehandling-af-reviews)
  * [Rådgivning og yderligere information](#rdgivning-og-yderligere-information)

Titel Vejledning og retningslinjer for arkitekturreviews
...
Vejledning og retningslinjer for arkitekturreviews giver indblik i processen og grundlaget for vurdering af projekter i review.
